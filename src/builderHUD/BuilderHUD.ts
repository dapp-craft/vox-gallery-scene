...
class BuilderHUD {
    ...
    private entityNameLabel: UIText;
    private entityTransformLabel: UIText;
    ...
    setupUI (){
        ...
        this.uiMaximizedContainer.height = 275
        ...
        this.selectPreviousButton.positionY = 100
        ...
        this.selectNextButton.positionY = 100
        ...
        this.discardItemButton.positionY = 100
        ...
        this.entityNameLabel = new UIText(this.uiMaximizedContainer)
        this.entityNameLabel.color = Color4.White()
        this.entityNameLabel.hAlign = 'left'
        this.entityNameLabel.vAlign = 'bottom'
        this.entityNameLabel.positionX = 10
        this.entityNameLabel.positionY = 82
        this.entityNameLabel.paddingTop = 0
        this.entityNameLabel.paddingBottom = 5
        this.entityNameLabel.paddingLeft = 5
        this.entityNameLabel.fontSize = 12
        this.entityNameLabel.fontWeight = 'bold'
        this.entityNameLabel.isPointerBlocker = false

        this.entityTransformLabel = new UIText(this.uiMaximizedContainer)
        this.entityTransformLabel.color = Color4.White()
        this.entityTransformLabel.hAlign = 'left'
        this.entityTransformLabel.vAlign = 'bottom'
        this.entityTransformLabel.positionX = 10
        this.entityTransformLabel.positionY = 67
        this.entityTransformLabel.paddingTop = 0
        this.entityTransformLabel.paddingBottom = 5
        this.entityTransformLabel.paddingLeft = 5
        this.entityTransformLabel.fontSize = 12
        this.entityTransformLabel.fontWeight = 'bold'
        this.entityTransformLabel.isPointerBlocker = false
        this.entityTransformLabel.value = "180, 180, 180"
        ...
        this.minimizeButton.positionY = 0
    ...
    updateTransformText(transform) {
        switch (this.mode){
            case this.modePOSITION:
                let position = transform.position
                this.entityTransformLabel.value = ""+this.round(position.x)+","+this.round(position.y)+","+this.round(position.z)
                break
            case this.modeROTATION:
                const r = transform.rotation.eulerAngles
                this.entityTransformLabel.value = ""+this.round(r.x)+","+this.round(r.y)+","+this.round(r.z)
                break
            case this.modeSCALE:
                let scale = transform.scale
                this.entityTransformLabel.value = ""+this.round(scale.x)+","+this.round(scale.y)+","+this.round(scale.z)
                break
            default:
                break
        }
    ...
    selectEntity(selectedEntityIndex:number){
        ...
        this.entityNameLabel.value = this.entities[selectedEntityIndex].entity.name
        ...
        this.updateTransformText(selectedEntityTransform)
    ...
    adjustTransform(key:string){
        ...
        this.updateTransformText(transform)
    }
...
//            position:new Vector3(camera.position.x-(pSX+1)*pX, 0-(pSY+1)*pY, camera.position.z-(pSZ+1)*pZ),
    ...
    dump(){
        ...
        for (let i in this.entities){
            ...
            let q = t.rotation
            let s = t.scale
            let pstring:string = ""+this.round(p.x)+","+this.round(p.y)+","+this.round(p.z)+",  "+this.round(r.x)+","+this.round(r.y)+","+this.round(r.z)+",  "+this.round(s.x)+","+this.round(s.y)+","+this.round(s.z) + "Q:"+ q.x+","+ q.y+","+ q.z+","+ q.w+";"
            log(""+name+"("+pstring+")")
        }
        log("-------------------------------------------------")
    }
